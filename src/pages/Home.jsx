  ...
  return (
    <main className="max-w-none mx-auto px-4 py-16">
      ...
      <section className="grid justify-center pt-3 pb-12">
        <div
          id="hero-bubble"
          className="relative w-full mx-auto text-center rounded-3xl p-6 md:p-8 md: ring-1 ring-white/20 backdrop-blur-xl shadow-[0_0_70px_rgba(82,246,197,0.22)] after:content-[''] after:absolute after:inset-0 after:rounded-3xl after:pointer-events-none after:shadow-[0_0_140px_rgba(82,246,197,0.26)] overflow-hidden backdrop-blur-2xl backdrop-saturate-150 z-10 md: md: lg: md: md: lg: md: lg: md: lg: md: lg: max-w-[820px] md:max-w-[980px] lg:max-w-[1120px] poppins bg-black/10"
        >
          <img
            src="/avatar.png"
          ...
          <p className="mx-auto max-w-[1200px] lg:max-w-[1240px] text-[16px] md:text-[17px] lg:text-[14px] md:text-[15px] lg:text-[16px]  md: lg: tracking-[0.005em] leading-7 md:leading-7 lg:leading-7 tracking-[0.005em]">
            A Minimalist Bayesian Sapien contributing to the universe's entropy, being an AI researcher building efficient, sustainable intelligence—optimizing models via pruning, distillation, quantization, and routing to deliver lighter and faster systems. I also apply Quantum ML to combinatorial optimization, turning vast search spaces into practical results.
          </p>
          <div className="mt-6">
            <a
